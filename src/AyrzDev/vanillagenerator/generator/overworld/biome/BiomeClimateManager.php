...
final class BiomeClimateManager
{
	...
	public static function init(): void
	{
		...
		self::register(
			new BiomeClimate(2.0, 0.0, false),
			BiomeIds::DESERT,
		...
		self::register(
			new BiomeClimate(0.25, 0.8, true),
			BiomeIds::TAIGA,
		...
		self::register(
			new BiomeClimate(0.8, 0.9, true),
			BiomeIds::SWAMPLAND,
			BiomeIds::SWAMPLAND_MUTATED
		);

		self::register(
			new BiomeClimate(0.0, 0.5, true),
			BiomeIds::ICE_PLAINS,
